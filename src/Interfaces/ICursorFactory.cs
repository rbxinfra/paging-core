...
public interface ICursorFactory
{
    ...
    /// </exception>
    string CreateCursor<TCursorInformation>(TCursorInformation cursorInformation)
    ...
    /// <param name="discriminator">The discriminator for verification (<see cref="CursorBase.Discriminator" />).</param>
    /// <returns>The <typeparamref name="TCursorInformation" />.</returns>
    /// <exception cref="ArgumentException">
    /// - <paramref name="cursor" /> is invalid.
    /// </exception>
    TCursorInformation ParseCursor<TCursorInformation>(string cursor, string discriminator = "")
        where TCursorInformation : CursorBase;
    ...
    bool TryParseCursor<TCursorInformation>(string cursor, out TCursorInformation cursorInformation, string discriminator = "")
        where TCursorInformation : CursorBase;
}
